...
const SchoolHistory = () => {
  return (
    <div className="flex justify-center items-center min-h-screen bg-gradient-to-r from-blue-500 to-indigo-700 p-6">
      <div className="p-8 max-w-3xl w-full bg-white rounded-2xl shadow-xl space-y-6 border border-gray-200">
        <h2 className="text-3xl font-bold text-center text-indigo-600">Our School History</h2>
        ...
        <div className="mt-6 text-center">
          <p className="text-indigo-600 font-semibold">"Education is the most powerful weapon which you can use to change the world." – Nelson Mandela</p>
        </div>
      </div>
    </div>
  );
